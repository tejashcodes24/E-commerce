        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-orange-100 overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to continue to TechBazaar</p>
            </div>
            ...
            <p className="text-center text-gray-600 text-sm mt-8">
              ...
              <a href="#" className="text-orange-600 hover:text-orange-700 font-semibold transition-colors ml-1">
                Sign up
              </a>
            </p>
          </div>
